...
/** Asset system model */
export type AssetFeatured_ImagePostArgs = {
...
export type AssetCreateInput = {
  ...
  featured_imagePost?: InputMaybe<PostCreateManyInlineInput>;
  fileName: Scalars['String'];
  handle: Scalars['String'];
...
export type AssetManyWhereInput = {
  ...
  featured_imagePost_every?: InputMaybe<PostWhereInput>;
  featured_imagePost_none?: InputMaybe<PostWhereInput>;
  featured_imagePost_some?: InputMaybe<PostWhereInput>;
...
export type AssetUpdateInput = {
  featured_imagePost?: InputMaybe<PostUpdateManyInlineInput>;
...
export type PostFeatured_ImageArgs = {
  locales?: InputMaybe<Array<Locale>>;
};
...
export type PostCreateInput = {
  ...
  createdAt?: InputMaybe<Scalars['DateTime']>;
  exerpect: Scalars['String'];
  featured_image: AssetCreateOneInlineInput;
  featured_post: Scalars['Boolean'];
  slug: Scalars['String'];
  title: Scalars['String'];
  updatedAt?: InputMaybe<Scalars['DateTime']>;
...
export type PostManyWhereInput = {
  ...
  /** All values containing the given string. */
  exerpect_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  exerpect_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  exerpect_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  exerpect_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  exerpect_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  exerpect_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  exerpect_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
  exerpect_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  exerpect_starts_with?: InputMaybe<Scalars['String']>;
  featured_image?: InputMaybe<AssetWhereInput>;
  featured_post?: InputMaybe<Scalars['Boolean']>;
  /** All values that are not equal to given value. */
  featured_post_not?: InputMaybe<Scalars['Boolean']>;
  id?: InputMaybe<Scalars['ID']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']>;
  /** All values ending with the given string. */
...
export enum PostOrderByInput {
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
  ExerpectAsc = 'exerpect_ASC',
  ExerpectDesc = 'exerpect_DESC',
  FeaturedPostAsc = 'featured_post_ASC',
  FeaturedPostDesc = 'featured_post_DESC',
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  PublishedAtAsc = 'publishedAt_ASC',
  PublishedAtDesc = 'publishedAt_DESC',
...
export type GetWorldPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', exerpect: string, createdAt: any, slug: string, title: string, author?: { __typename?: 'Author', bio?: string | null, name: string, id: string, photo?: { __typename?: 'Asset', url: string } | null } | null, featured_image: { __typename?: 'Asset', url: string }, categories: Array<{ __typename?: 'Category', name: string, slug: string }> }> };

export type GetBusinessPostsQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']>;
}>;
...
export type GetFeaturedPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', exerpect: string, createdAt: any, slug: string, title: string, author?: { __typename?: 'Author', bio?: string | null, name: string, id: string, photo?: { __typename?: 'Asset', url: string } | null } | null, featured_image: { __typename?: 'Asset', url: string }, categories: Array<{ __typename?: 'Category', name: string, slug: string }> }> };

export type GetCategoriesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCategoriesQuery = { __typename?: 'Query', categories: Array<{ __typename?: 'Category', name: string }> };
